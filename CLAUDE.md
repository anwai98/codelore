...
- Run `tests/test-hooks.sh` after you change a file in `hooks/`, or `AGENTS.md`, or `CLAUDE.md`.
- Run `claude plugin validate . --strict` after you change a manifest in `.claude-plugin/`.
